...
function Sidebar() {
  return (
    <div className='w-46 lg:flex hidden cursor-pointer fixed top-0 left-0 z-50 px-4 pt-20 h-full gap-y-6 justify-start items-start flex-col bg-UIslate-50  border-r-2 '>
