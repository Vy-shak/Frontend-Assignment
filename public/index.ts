import MentorIcon from "./Icons/MentorIcon.svg";
import BookingIcon from "./Icons/Bookingicon.svg";
import JobIcon from "./Icons/Jobicon.svg";
import PriorityIcon from "./Icons/PriorityDm.svg";
...
export {MentorIcon,BookingIcon, NumberListicon, Quoteicon, Uploadimg, BulletIcon,Link,UploadVideo,ImojiIcon, Boldicon,ItalicIcon,StrikeIcon,Underlineicon, Stars, CalenderIcon, CheveronRight, Profile1,Profile2,Profile3, Product,WebinarIcon, Tumbnail2, RupeeIcon,MessageIcon,Block,BlueClock,VideoIcon, Arrowback, LinkdinIcon, Mediumicon,InstagramIcon,ShareIcon,Xicon, ClockIcon, SearchIcon, CloseIcon, TrendingIcon, Jhony,Dev,Rishi,Mistry, Bellicon, VerifyIcon, ProfileImg, CheveronDown,JobIcon,PriorityIcon}